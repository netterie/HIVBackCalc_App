...
####    3.5 Uploading data to the HIVBackCalc App.
  ...
  1. From the _load data_ tab on the HIVBackCalc app you ccan specify the data file format.  The default settings specify that the data has headers, is comma delineated and uses double quotes.  The default is the correct specification for the example data file.
